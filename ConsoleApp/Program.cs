...
namespace ConsoleApp
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            GetTPEntitiesDoneButNotTested(); // Scenario 1
            Thread.Sleep(5000);
            GetTPEntitiesMarkedAsNotDone(); // Scenario 2
            Thread.Sleep(5000);
            CannotIdentifyUSfromCommitComments(); // Scenario 3
            Thread.Sleep(5000);
            GetCommitsWithoutAssociatedSprint(); // Scenario 4
            Thread.Sleep(5000);
            GetTPEntitiesMarkedDoneWithCommits(); // Scenario 5
            Thread.Sleep(5000);
            GetTPEntitiesMarkedAsDevCompleteWithDevTasksNotClosed(); // Scenario 6
            Thread.Sleep(5000);
            GetTPEntitiesMarkedAsQACompleteWithQATasksNotClosed(); // Scenario 7
            Thread.Sleep(5000);
            GetTPEntitiesMarkedAsDoneWithNoDevTasks(); // Scenario 8
            Thread.Sleep(5000);
            GetTPEntitiesMarkedAsDoneWithNoQATasks(); // Scenario 9
            Thread.Sleep(5000);
            GetCurrentSprintCommitsPlacedIntoPreviousReleaseCandidate(); // Scenario 10
            Thread.Sleep(5000);
            GetUSWithoutDeveloperScreenshots(); // Scenario 11
            Thread.Sleep(5000);
            GetListOfAllTeamCityBuildsForThisSprint(); // Scenario 12
            Thread.Sleep(5000);
        ...
        private static void GetTPEntitiesMarkedAsDoneAndTasksNotComplete() // Inactive Scenario but functional
        {
        ...
        private static void GetListOfActiveBranchesForCurrentSprint() // This method can be used to locate any branches with commits since the last Release based on Tags
        {
        ...
        #region Target Process Entities
